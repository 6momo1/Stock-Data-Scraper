...
$ python3 scrapeStock aapl googl tsla
        ...
        Youstock_data.cs: float=0. headadadut=timeoue the dataDataFr Create a csv file ditional_headers, timeouitional_headers=eaders=sted headers are: Idx, Market_Cap, Income, Price
...
For example, get data from the stock Apple:
